import { BlockType, CustomCommandParamType, Entity, EntityType, ItemType, Player, Vector3 } from "@minecraft/server";
...
export type ExtractParamTypes<T extends {
...
export type ExtractParamTypesOptional<T extends {
    type: CustomCommandParamType;
}[]> = {
    [K in keyof T]: T[K] extends {
        type: infer P;
...
declare module "@minecraft/server" {
    interface CustomCommandRegistry {
        ...
        }, cb: (origin: CustomCommandOrigin, ...data: [...ExtractParamTypes<M>, ...ExtractParamTypesOptional<O>]) => CustomCommandResult | undefined): void;
    }
}
